...
async def help_message_f(client, message):
    ...
    if UPDATES_CHANNEL is not None:
        try:
            ...
            if user.status == "kicked":
               await message.reply_text(
                   text="Sorry Sir, You are Banned to use me. Contact [𝗝𝗔𝗖𝗞𝗕𝗥𝗢](https://t.me/Jackbro007).",
                   parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact [𝗝𝗔𝗖𝗞𝗕𝗥𝗢](https://t.me/Jackbro007).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('𝗚𝗥𝗢𝗨𝗣', url='https://t.me/onlymovies76'),
                    InlineKeyboardButton('𝗢𝗡𝗪𝗘𝗥', url='https://t.me/Jackbro007'),
                    InlineKeyboardButton('𝗖𝗛𝗔𝗡𝗡𝗘𝗟', url='https://t.me/onlyseries76')
                ],
                [
